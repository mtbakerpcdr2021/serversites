...
<script type="text/javascript">
 ...
 $(document).ready(function()   { 
   ...
   if (cartalerted != 'yes') {
    ...
    swal("Alert!", "Before completing your order make sure all information is 100% accurate in the address field or this could cause delays and/or cancelations of your order."); 
  }
...
<body class="">
  ...
  $sessionid=$_SESSION['guestid'];

  if(isset($_GET['delid']) ){  

    $id=$_GET['delid'];   
    $del ="DELETE FROM guestcart WHERE id = $id";
            ...
            <div class="table-responsive">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                 ...
                 $query = mysqli_query($con, "SELECT * FROM guestcart WHERE G_id = '$sessionid'");
                 $check=0;
                 while($cart = mysqli_fetch_assoc($query)){ 
                  ...
                  <script type="text/javascript">
                    function deleteproduct(id){
                      // alert(id);
                      window.location.href="guestcart.php?delid="+id;
                  ...
                  <tr>
                    ...
                    <td>Shipping 
                      <br>
   <input class="shipoption" type="radio" name="shiptype" id="usp" value="usp" > USPS</input>
 <br>

                      <input class="shipoption autoclickbycoupon" type="radio" name="shiptype" value="fedex" checked style="margin-left: 0px;" > Fedex</input>
        ...
        <div class="col mb-2">
          ...
          <div class="row">
            ...
            <!-- <form action="cart.php" method="post" class="col-sm-12 col-md-4 "> -->
              <div class="col-sm-12 col-md-3 customwidth" title="Accept terms & conditons and click on cod checkmark for USPS">
                <button type="submit" class="btn btn-lg btn-block btn-info text-uppercase" name="cod" disabled id="bn" data-toggle="modal" data-target="#exampleModal">Cash On Delivery</button>
              </div>
              <!-- </form> -->
              <!-- <form action="cart.php" method="post" class="col-sm-12 col-md-4 "> -->
                <div class="col-sm-12 col-md-3 customwidth" title="Accept terms & conditions">
                  <button class="btn btn-lg btn-block btn-success text-uppercase stopclick" target="_blank" id="checkoutlink" name="cryptocheckout"  data-toggle="modal" data-target="#exampleModal1">CRYPTO Checkout</button>
                </div>
                <div class="col-sm-12 col-md-3 customwidth" title="Accept terms & conditions">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" onclick="guestcod();">Proceed</button>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-6">
                      <!-- <form action="login.php" method="post"> -->
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Full Name *" name="echeckName" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Phone * e.g: 323-232-3232" name="echeckphone" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="City *" name="echeckcity" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="State * e.g: WA" name="echeckstate" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Zip Code * e.g: 12345"  name="echeckzip" required/>
                        </div>
                        <div class="form-group">
                          <input type="email" class="form-control" placeholder="Email *" name="echeckemail" required />
                        </div>
                        <div class="form-group">
                          <textarea  placeholder="Shipping Address" data-form-field="Address" class="form-control display-7" id="Address-formbuilder-w" style="height: 92px;" required name="echeckaddress"></textarea>
                        </div>
                      </div>
                      <div class="col-md-6">
...
<div class="form-group">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="echeckcheckout();">Proceed Payment</button>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="modal-body">
                  <div class="row register-form">
                    <div class="col-md-6">
                      <!-- <form action="login.php" method="post"> -->
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Full Name *" name="Name1" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Phone *" name="phone1" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="City *" name="city1" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="State *" name="state1" required/>
                        </div>
                        <div class="form-group">
                          <input type="text" class="form-control" placeholder="Zip Code *" name="zip1" required/>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <input type="email" class="form-control" placeholder="Email *" name="email1" required  id="email1"/>
                        </div>

                        <div class="form-group">
                          <textarea  placeholder="Shipping Address" data-form-field="Address" class="form-control display-7" id="Address-formbuilder-w" style="height: 92px;" required name="address1"></textarea>
                        </div>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" onclick="gatewaycheckout();">Proceed</button>
                  </div>
                </div>
              </div>
...
$("#codoption").click(function(){
  ...
  ///
                                   ...
                                   $.ajax({
                                    ...
                                    success:function(data){
                                          ...
                                          couponcheck=1;
                                                ...
                                                // $('#discountamount').html('-$'+discountedamout);
    ...
    var sessionname=$("input[name=Name1]").val();  
    var saddress=$("textarea[name=address1]").val(); 
    var sphone=$("input[name=phone1]").val();  
    var semail=$("input[name=email1]").val(); 
    var szip=$("input[name=zip1]").val();  
    var city1=$("input[name=city1]").val();  
    var state1=$("input[name=state1]").val();  


    var sadminemail="<?php echo $result112['email']; ?>";

    var data={cryptocheckoutguest:"cryptocheckoutguest",check:check,totalcheckout:totalcheckout,sessionid:sessionid,sessionname:sessionname,saddress:saddress,sphone:sphone,semail:semail,szip:szip,codetail:codetail,sadminemail:sadminemail,shipType:shipType,pIDS:productidsinJS,weightozJS:weightozinJs,couponcode1:couponcode,discount1:discount,city1:city1,state1:state1};
  ...
  function echeckcheckout(){
          ...
          var sessionid="<?php echo $sessionid ?>";
          var sessionname=$("input[name=echeckName]").val();
          var saddress=$("textarea[name=echeckaddress]").val(); 
          var sphone=$("input[name=echeckphone]").val();  
          var semail=$("input[name=echeckemail]").val(); 
          var szip=$("input[name=echeckzip]").val(); 

          var echeckaccountnumber=$("input[name=echeckaccountnumber]").val(); 
          var echeckroutingnumber=$("input[name=echeckroutingnumber]").val(); 

          var echeckcity=$("input[name=echeckcity]").val(); 
          var echeckstate=$("input[name=echeckstate]").val(); 
    ...
    var data={echeckpayment:"echeckpayment",guestecheckcheckout:"guestecheckcheckout",check:check,totalcheckout:priceIncludeEcheckFees,sessionid:sessionid,sessionname:sessionname,saddress:saddress,sphone:sphone,semail:semail,szip:szip,codetail:codetail,sadminemail:sadminemail,echeckaccountnumber:echeckaccountnumber,echeckroutingnumber:echeckroutingnumber,shipType:shipType,pIDS:productidsinJS,weightozJS:weightozinJs,couponcode1:couponcode,discount1:discount,echeckcity:echeckcity,echeckstate:echeckstate};
    
     var data1={echeckpayment:"echeckpayment",guestecheckcheckout:"guestecheckcheckout",check:check,totalcheckout:priceIncludeEcheckFees,sessionid:sessionid,sessionname:sessionname,saddress:saddress,sphone:sphone,semail:semail,szip:szip,codetail:codetail,sadminemail:sadminemail,echeckaccountnumber:echeckaccountnumber,echeckroutingnumber:echeckroutingnumber,shipType:shipType,pIDS:productidsinJS,weightozJS:weightozinJs,couponcode1:couponcode,discount1:discount,echeckcity:echeckcity,echeckstate:echeckstate};
              ...
              if(data=='done'){
                // alert('done');
                  ...
                  $.ajax({
                    ...
                    });//ajax call for order setup in site
  ...
  function guestcod(){
    ...
    var sessionid="<?php echo $sessionid ?>";
    var sessionname=$("input[name=Name]").val();  
    var saddress=$("textarea[name=address]").val(); 
    var sphone=$("input[name=phone]").val();  
    var semail=$("input[name=email]").val(); 
    var szip=$("input[name=zip]").val(); 
    var scity=$("input[name=city]").val(); 
    var sstate=$("input[name=state]").val(); 
    var codetail="<?php echo $coddetail; ?>";   
    var sadminemail="<?php echo $result112['email']; ?>";


    var data={guestcod:"guestcod",check:check,totalcheckout:totalcheckout,sessionid:sessionid,sessionname:sessionname,saddress:saddress,sphone:sphone,semail:semail,szip:szip,scity:scity,sstate:sstate,codetail:codetail,sadminemail:sadminemail,shipType:shipType,pIDS:productidsinJS,weightozJS:weightozinJs,couponcode1:couponcode,discount1:discount};
    $.ajax({
      url:"getorder.php",
      method:"post",
      cache:false,
