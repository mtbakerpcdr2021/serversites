                    ...
                    <table class="table" id="mytable">
                      ...
                      <tbody>
                       <?php 
                          $orderid="";
                          $sessionid=$_SESSION['C_id'];
                          $query = mysqli_query($con, "SELECT * FROM orders where C_id='$sessionid'");
                         ...
                         ?><tr>
                            ...
                            <td>
                              <button class="btn btn-info viewbtn" id='<?php echo $order['orderid']; ?>'
                                  >View</button>
                            </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" id="orderdetail">
       ...
       <!--  <?php 
         $id= "<script type='text/javascript'> document.write(check); </script>";
         echo $id;
         ?> -->
      </div>
