    ...
    <?php 
      ...
      if(!isset($_SESSION['AdminloggedIn'])){
       ...
       if(isset($_POST['updatepassword'])){
          ...
          $email= $_POST['email'];
          $fshipping= $_POST['shippingfees'];
          $fshipping2= $_POST['shippingfees2'];
            ...
            if(!$con){
              ...
              return;
                      ...
                      $insertQuery = "UPDATE admin SET password='$hashedPassword', email='$email',shipping='$fshipping',shipping2='$fshipping2'";
                ...
                <div class="card-body" style="margin-top: 20px;">
                  <form action="adminsetting.php" method="post"  autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Base shipping Fees $</label>
                          <input value="<?php echo (int)$shipping ?>" required type="number" name="shippingfees" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">shipping Fees Over $75 order</label>
                          <input value="<?php echo (int)$shipping2 ?>" required type="number" name="shippingfees2" class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Email to receive COD details</label>
