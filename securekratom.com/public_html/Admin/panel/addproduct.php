                  ...
                  <form action="addproduct.php" method="post" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <select style="width: 75%;" name="p_category" required="">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Quantity: e.g 5</label>
                          <input type="number" name="quantity" class="form-control" required=""> 
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="">Unit of quantity:</label>
                          <input type="text" name="unit" class="form-control" placeholder="e.g    gram, oz, kg">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-md-3">
                        <div class="form-group">
                          <label class="">Available Weight in OZ: </label>
                          <input type="number" name="availableweight" class="form-control" placeholder="e.g 100" >
                        </div>
                      </div> -->
                      <div class="col-md-3">
                        <!-- <div class="form-group"> -->
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input required type="text" name="p_desc" class="form-control" >
                        </div>
                      </div>
                    </div>
                    
                    <button type="submit" class="btn btn-primary pull-right" name="addproduct"><b>Add Product</b></button>
  ...
  if(isset($_POST['addproduct'])){
   ...
   $p_desc=$_POST['p_desc'];
    ...
    if(!$con){
      ...
      $insertQuery = "INSERT INTO products(name,quantity,quantityunit,price,image,category_id,p_desc)VALUES ('$name', '$quantity','$unit','$price','$image','$p_category','$p_desc')";
