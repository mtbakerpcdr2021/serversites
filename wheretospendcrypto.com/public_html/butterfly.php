...
<html>
<head>
	<title>The Florida Native Butterfly Society Conservatory</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from butterfly.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="butterfly.php" method="POST">
		<div class="container">
