...
<html>
<head>
	<title>Cheela Santhosh MD</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Cheela Santhosh MD";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on cheela.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="cheela.php" method="POST">
		<div class="container">
