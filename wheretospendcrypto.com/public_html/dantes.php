...
<html>
<head>
	<title>Dante's Live Music and Entertainment</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from dantes.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="dantes.php" method="POST">
		<div class="container">
