...
<html>
<head>
	<title>Acoustic Panels Canada</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from apc.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on apc.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="apc.php" method="POST">
		<div class="container">
