...
<html>
<head>
	<title>Forest Hill Bagels</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from foresthill.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="foresthill.php" method="POST">
		<div class="container">
