...
<html>
<head>
	<title>Veganics Vegan Catering</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike veganics.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on v.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="veganics.php" method="POST">
		<div class="container">
