...
<html>
<head>
	<title>Genius Computer Repair</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from genius.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="genius.php" method="POST">
		<div class="container">
