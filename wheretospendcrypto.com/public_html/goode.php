	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from goode.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on goode.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="goode.php" method="POST">
		<div class="container">
