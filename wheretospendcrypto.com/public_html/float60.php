...
<html>
<head>
	<title>Float Sixty River North</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from float60.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Float Sixty River North</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="float60.php" method="POST">
		<div class="container">
