...
<html>
<head>
	<title>Butter Tree Studios</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from ButterTree Studios";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on buttertree.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="buttertree.php" method="POST">
		<div class="container">
