	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from mensgr.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="mensgr.php" method="POST">
		<div class="container">
