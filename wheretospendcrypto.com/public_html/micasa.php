...
<html>
<head>
	<title>Mi Casa Es Tu Casa</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from micasa.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on micasa.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="micasa.php" method="POST">
		<div class="container">
