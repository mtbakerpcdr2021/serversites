	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from midoma.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="midoma.php" method="POST">
		<div class="container">
