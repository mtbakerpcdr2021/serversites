	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from paragon.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="paragon.php" method="POST">
		<div class="container">
