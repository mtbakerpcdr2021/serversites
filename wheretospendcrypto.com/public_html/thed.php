	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from thed.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on The D Las Vegas</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="thed.php" method="POST">
		<div class="container">
