...
<html>
<head>
	<title>Litte Bloom Lao&Thai Cuisine</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from littlebloom.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="littlebloom.php" method="POST">
		<div class="container">
