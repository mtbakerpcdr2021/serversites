...
<html>
<head>
	<title>Lamborghini Newport Beach</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike lambo.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on lambo.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="lambo.php" method="POST">
		<div class="container">
