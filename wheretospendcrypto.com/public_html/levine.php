...
<html>
<head>
	<title>Jonathan Levine Projects</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from levine.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="levine.php" method="POST">
		<div class="container">
