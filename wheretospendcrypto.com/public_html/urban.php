	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from urban.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on urban.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="urban.php" method="POST">
		<div class="container">
