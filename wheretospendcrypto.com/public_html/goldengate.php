...
<html>
<head>
	<title>Golden Gate Casino Hotel</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from goldengate.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Golden Gate Casino Hotel</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="goldengate.php" method="POST">
		<div class="container">
