	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from cassava.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Cassava Empanadas</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="cassava.php" method="POST">
		<div class="container">
