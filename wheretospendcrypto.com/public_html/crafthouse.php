	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from crafthouse.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="crafthouse.php" method="POST">
		<div class="container">
