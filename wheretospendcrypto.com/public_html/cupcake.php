	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from cupcake.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on cupcake.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="cupcake.php" method="POST">
		<div class="container">
