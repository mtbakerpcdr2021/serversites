	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Hellers";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on hellers.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="hellers.php" method="POST">
		<div class="container">
