	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from supperbell.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="supperbell.php" method="POST">
		<div class="container">
