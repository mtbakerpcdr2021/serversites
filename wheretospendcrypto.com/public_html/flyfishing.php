...
<html>
<head>
	<title>Pacific Fly Fishing Charters</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike flyfishing.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on flyfishing.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="flyfishing.php" method="POST">
		<div class="container">
