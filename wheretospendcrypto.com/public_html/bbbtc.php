...
<html>
<head>
	<title>Bed, Breakfast and Bitcoin</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from bbbtc.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="bbbtc.php" method="POST">
		<div class="container">
