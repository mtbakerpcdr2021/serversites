...
<html>
<head>
	<title>Divine Flooring and Surface Store</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from divine.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="divine.php" method="POST">
		<div class="container">
