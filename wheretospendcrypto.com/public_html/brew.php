	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from brew.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on brew.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="brew.php" method="POST">
		<div class="container">
