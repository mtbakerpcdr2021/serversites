	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from cinbox.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="cinbox.php" method="POST">
		<div class="container">
