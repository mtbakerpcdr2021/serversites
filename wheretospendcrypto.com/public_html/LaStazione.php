...
<html>
<head>
	<title>La Stazione Bakery & Cafe</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from LaStazione.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on LaStazione.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="LaStazione.php" method="POST">
		<div class="container">
