...
<html>
<head>
	<title>Green and White Wellness Center</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Green and White Wellness Center";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on greenandwhite.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="greenandwhite.php" method="POST">
		<div class="container">
