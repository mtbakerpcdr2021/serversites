...
<html>
<head>
	<title>Rejuvenation Clinics of Australia</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from rejuv.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Rejuvenation Clinics of Australia</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="rejuv.php" method="POST">
		<div class="container">
