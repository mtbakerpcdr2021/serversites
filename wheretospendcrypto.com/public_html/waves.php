...
<html>
<head>
	<title>David Good Bronze Sculpture</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from waves.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on waves.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="waves.php" method="POST">
		<div class="container">
...
<section class="mbr-section content1 cid-rvR0QwUMzs" id="content1-t">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <p class="mbr-text mbr-fonts-style mbr-light display-7">Waves Coffee House</br>Cofee Shop</br><a href="https://wavescoffee.com" class="text-info">Click For Website</a></br>Crypto Accepted:Bitcoin & has btc ATM</br><a href="https://projectfts.org" class="text-info">Click For Projectfts.org</a></br><a href="https://ftsmaps.com" class="text-info">Click here to go Back To FTSMAPS</a></p>
            </div>
        </div>
    </div>
</section>
