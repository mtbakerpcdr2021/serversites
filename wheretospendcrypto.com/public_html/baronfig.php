	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Baronfig.php";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="baronfig.php" method="POST">
		<div class="container">
