	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike Elevated.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Elevated.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="elevated.php" method="POST">
		<div class="container">
