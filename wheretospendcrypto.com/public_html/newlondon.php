	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from New London Pizza";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on newlondon.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="newlondon.php" method="POST">
		<div class="container">
