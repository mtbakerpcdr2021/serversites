	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Mt Baker PC DR";
		    $message = '<html><body>';
	 ...
	 ?>
	<form action="pcdr.php" method="POST">
		<div class="container">
...
<section class="mbr-section content1 cid-rvR0QwUMzs" id="content1-t">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <p class="mbr-text mbr-fonts-style mbr-light display-7">Mt. Baker PC Dr.</br>In home Pc Repair Business</br><a href="https://mtbakerpcdr.com" class="text-info">Click For Website</a></br>Crypto Accepted:Bitcoin, Monero, Tron, BCH ABC, DASH</br><a href="https://projectfts.org" class="text-info">Click For Projectfts.org</a></br><a href="https://ftsmaps.com" class="text-info">Click here to go Back To FTSMAPS</a></p>
            </div>
        </div>
    </div>
</section>
