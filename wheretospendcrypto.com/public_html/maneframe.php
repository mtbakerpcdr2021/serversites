...
<html>
<head>
	<title>Maneframe Hairdooz</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike maneframe.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on maneframe.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="maneframe.php" method="POST">
		<div class="container">
