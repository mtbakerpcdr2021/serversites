	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Ample Air";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on ampleair.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="ampleair.php" method="POST">
		<div class="container">
