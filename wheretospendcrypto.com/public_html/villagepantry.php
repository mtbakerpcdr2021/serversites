...
<html>
<head>
	<title>Village Pantry Deli</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Village Pantry";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on villagepantry.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="villagepantry.php" method="POST">
		<div class="container">
