...
<html>
<head>
	<title>Paul Sulzycki MSc, RMT</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from nwm.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on nwm.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="nwm.php" method="POST">
		<div class="container">
