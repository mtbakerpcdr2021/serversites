...
<html>
<head>
	<title>Andiamo Steakhouse</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from andiamo.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on Andiamo Steakhouse</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="andiamo.php" method="POST">
		<div class="container">
