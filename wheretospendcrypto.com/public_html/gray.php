...
<html>
<head>
	<title>Gray & Sons Jewelers</title>
...
<section class="footer1 cid-rv8tljIIgM" id="footer1-3">
	<?php
	 ...
	 ?>
	<form action="gray.php" method="POST">
		<div class="container">
