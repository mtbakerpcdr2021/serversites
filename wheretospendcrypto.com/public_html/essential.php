...
<html>
<head>
	<title>Essential Sleep - Natural Mattress & Bedding Gallery</title>
	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike essential.php";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on essential.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="essential.php" method="POST">
		<div class="container">
