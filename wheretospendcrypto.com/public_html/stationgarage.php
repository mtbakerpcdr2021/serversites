	...
	<?php
		...
		if (mysqli_connect_errno())
		  ...
		  if(isset($_POST['dislikebtn'])){
		    ...
		    $subject = "Dislike from Station Garage";
		    $message = '<html><body>';
		    $message .= '<p style="color:#000;font-size:18px;">Dislike button pressed on stationgarage.php</p>';
		    $message .= '</body></html>';
	 ...
	 ?>
	<form action="stationgarage.php" method="POST">
		<div class="container">
