...
<html>
<head>
	<title>Briz Loan and Guitar</title>
...
<section class="mbr-section content1 cid-rvR0QwUMzs" id="content1-t">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <p class="mbr-text mbr-fonts-style mbr-light display-7">Briz Guitar and Loan</br>(360) 699-5626</br><a href="http://briz.com" class="text-info">Click For Website</a></br>Crypto Accepted:Bitcoin and some others</br><a href="https://projectfts.org" class="text-info">Click For Projectfts.org</a></br><a href="https://ftsmaps.com" class="text-info">Click here to go Back To FTSMAPS</a></p>
            </div>
        </div>
    </div>
</section>
