...
var restore_keys = function(lang) {
  ...
  re_address_widget.innerHTML = keys.public_addr;
  re_mnemonic_widget.innerHTML = seed_phrase;
  re_spend_key_widget.innerHTML = keys.spend.sec;
  re_view_key_widget.innerHTML = keys.view.sec;

  document.getElementById("re-step2").style.display = "block";
  document.getElementById("re-step3").style.display = "block";
  document.getElementById("re-step4").style.display = "block";
  document.getElementById("re-step5").style.display = "block";

};

var genwallet = function(lang) {
  document.getElementById("ge-step2").style.display = "block";
  document.getElementById("ge-step3").style.display = "block";
  document.getElementById("ge-step4").style.display = "block";
  document.getElementById("ge-step5").style.display = "block";
