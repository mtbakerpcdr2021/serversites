            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Coin Proofs</h4>
                    ...
                    <table class="table" id="mytable" >
                      ...
                      <tbody>
                       <?php 
                          // $orderid="";
                          // $sessionid=$_SESSION['C_id'];
                          $query = mysqli_query($con, "SELECT * FROM coinproofs");
                         ...
                         ?><tr>
                            ...
                            <td><?php echo $details['walletaddress']; ?></td>
                            <td><?php echo $details['businessinfo']; ?></td>
                            <td><?php echo $details['yourinfo']; ?></td>
                            <td>
                              <!-- <?php echo $details['uploadedfile']; ?> -->
                              

                              <video width="400" controls>
                                <source src="<?php echo "../../assets/uploadedvids/".$details['uploadedfile']; ?>" type="video/mp4">
                            ...
                            <td>
                                  ...
                                  <button class="btn btn-danger delbtn" title="delete" id='<?php echo $details['id']; ?>'
