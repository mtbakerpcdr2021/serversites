...
<body>
	<?php 
		if(isset($_GET['id']) ){  
			...
			$con = connecttoDB();
			$query = mysqli_query($con, "SELECT * FROM ufolocations where id=$id");  
		...
		if(isset($_POST['update'])){
			...
			$updateLocationQuery = "UPDATE ufolocations SET ufoname='$name',ufolink='$link',lat='$lat',longi='$longi',color='$color' WHERE id='$id'";
