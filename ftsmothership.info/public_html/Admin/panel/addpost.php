 ...
 ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input required type="text" name="p_heading" class="form-control" required="">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Short Description</label>
                          <input required type="text" name="p_shortdesc" class="form-control" >
                        </div>
                      </div>
                    <div class="col-md-3">
                        <!-- <div class="form-group"> -->
                          <label class="bmd-label-floating">Main Image</label>
                          <input required type="file" name="p_img" class="form-control" >
                        <!-- </div> -->
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="p_desc" class="form-control" rows="15"></textarea>
                        </div>
                      </div>
                    </div>
                    
                    <button type="submit" class="btn btn-primary pull-right" name="addpost"><b>Add Post</b></button>
  ...
  if(isset($_POST['addpost'])){
    ...
    if(!$con){
      ...
      $insertQuery = "INSERT INTO posts(p_heading,p_img,p_desc,p_shortdesc)VALUES
       ('$p_heading', '$p_img','$p_desc','$p_shortdesc')";
